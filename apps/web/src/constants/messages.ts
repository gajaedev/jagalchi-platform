...
export const COMMUNITY_MESSAGES = {
  NOT_FOUND: '실행 과제를 찾을 수 없습니다.',
  VIEW_ROADMAP: '실행 과제 보기',
  ADD_TO_MY_ROADMAPS: '내 과제로 복사',
  ...
  LOADING: '불러오는 중...',
  LOADING_DETAIL: '실행 과제 정보를 불러오는 중...',
  ERROR_LOAD_FAILED: '실행 과제를 불러오는데 실패했습니다.',
  FORK_SUCCESS: '실행 과제를 내 목록에 복사했습니다.',
  FORK_FAILED: '실행 과제 복사에 실패했습니다.',
  FORK_COUNT_LABEL: '복사',
  SAVED_EMPTY: '저장된 실행 과제가 없습니다.',
  // Hero
  HERO_TITLE: '어떤 결과물 과제를 찾고 있나요?',
  SEARCH_ARIA: '검색',
  BACK_ARIA: '뒤로가기',
  // Grid
  SEARCH_EMPTY: '검색 결과가 없습니다.',
  POPULAR_EMPTY: '인기 실행 과제가 없습니다.',
  // Filter
  TAB_POPULAR: '인기',
  TAB_LATEST: '최신',
  TAB_SAVED: '저장한 과제',
  ...
  SORT_SIZE: '크기순',
  FILTER_ALL: '전체',
  FILTER_ROADMAP: '실행 과제',
  FILTER_DIRECTORY: '과제 폴더',
} as const;

export const MY_ROADMAPS_MESSAGES = {
  SEARCH_PLACEHOLDER: '실행 과제 검색',
  NEW_ROADMAP: '실행 과제',
  NEW_DIRECTORY: '과제 폴더',
  ...
  // Header
  HEADER_TITLE: '내 실행 과제',
  HEADER_ROADMAP_SUFFIX: '실행 과제',
  // Toolbar
  ALL_ROADMAPS: '전체 실행 과제',
  EMPTY: '아직 실행 과제가 없습니다',
  SEARCH_EMPTY: '검색 결과가 없습니다',
  // Sidebar
  SIDEBAR_RECENT: '최근 실행',
  SIDEBAR_COMMUNITY: '과제 템플릿',
  SIDEBAR_MY_ROADMAP: '내 실행 과제',
  SIDEBAR_SHARED: '공유받은 과제',
  ...
  CARD_DELETE: '삭제',
  // AddRoadmapModal
  ADD_ROADMAP_TITLE: '실행 과제 추가',
  ADD_ROADMAP_PLACEHOLDER: '만들 결과물을 입력하세요',
  ADD_ROADMAP_DETAIL: '완료 조건 설정하기',
  // SelectLocationModal
...
export const PROFILE_MESSAGES = {
  BIO_TITLE: '자기소개',
  COMPLETED_ROADMAP: '완료한 실행 과제',
  IN_PROGRESS_ROADMAP: '진행 중인 실행 과제',
  MADE_ROADMAP: '만든 실행 과제',
  // ProfilePicture
  ...
  ADD_PUBLIC_ROADMAP: '공개 실행 과제 추가',
  SELECT_ROADMAP_TITLE: '실행 과제 선택',
  SEARCH_ROADMAP_PLACEHOLDER: '실행 과제 검색',
  SEARCH_EMPTY: '검색 결과가 없습니다.',
  CANCEL: '취소',
  CONFIRM: '확인',
  // Follow
...
export const VIEWER_MESSAGES = {
  // Learning Coach
  COACH_TITLE: 'AI 실행 코치',
  COACH_TAB_FEEDBACK: '실행 피드백',
  COACH_TAB_QA: '질문하기',
  COACH_LOADING: 'AI가 분석 중...',
  COACH_FEEDBACK_EMPTY: '선택한 단계의 실행 피드백을 받아보세요',
  COACH_FEEDBACK_REQUEST: '피드백 받기',
  COACH_SCORES: '증거 품질',
  COACH_STRENGTHS: '잘한 점',
  COACH_GAPS: '보완할 점',
  COACH_NEXT_ACTIONS: '다음 실행 행동',
  COACH_QUESTION_PLACEHOLDER: '실행 단계에 관한 질문을 입력하세요',
  COACH_ASK: '질문',
  COACH_SOURCES: '참고 자료',
  COACH_QA_EMPTY: '현재 실행 단계에 관해 질문해보세요',
  COACH_CLOSE: '닫기',
  ...
  // Fork
  FORK_BUTTON: '내 과제로 복사',
  FORK_SUCCESS: '실행 과제를 내 목록에 복사했습니다',
  FORK_ALREADY_FORKED: '이미 내 과제로 복사했습니다',
  // Header
  AI_FEEDBACK_BUTTON: 'AI 실행 피드백',
  SEARCH_PLACEHOLDER: '실행 단계 검색',
  DEFAULT_ROADMAP_TITLE: '새 실행 과제',
  // Header menus
  MENU_STATISTICS: '과제 통계',
  ...
  // Sidebar
  SIDEBAR_TITLE: '완료 단계',
  SIDEBAR_SEARCH_PLACEHOLDER: '실행 단계 검색',
  SIDEBAR_EMPTY: '실행 단계가 없습니다',
  SIDEBAR_DETAIL_DESCRIPTION: '완료 조건',
  SIDEBAR_DETAIL_RESOURCES: '증거 및 참고 링크',
  SIDEBAR_TOTAL_COUNT: '총 {count}개 단계',
  // Progress
  PROGRESS_LABEL: '증거 완성률',
  NODE_COMPLETED: '증거 완료',
  NODE_INCOMPLETE: '증거 미완료',
  // Loading/Error
  LOADING: '실행 과제를 불러오는 중...',
  ERROR_NOT_FOUND: '실행 과제를 찾을 수 없습니다',
  ERROR_LOAD_FAILED: '실행 과제를 불러오는데 실패했습니다',
  // View mode
  VIEW_CANVAS: '캔버스',
  VIEW_CARDS: '카드',
  // Sidebar toggle
  SIDEBAR_OPEN_BUTTON_LABEL: '완료 단계 열기',
  // Export image
...
export const EDITOR_MESSAGES = {
  ...
  // Multi-select
  MULTI_SELECT_NODE_LABEL: '단계',
  // ErrorFallback
  ERROR_CANNOT_LOAD: '실행 과제를 불러올 수 없습니다',
  ERROR_RETRY: '다시 시도',
  ERROR_BACK_TO_ROADMAPS: '내 실행 과제로 돌아가기',
  SAVE_SUCCESS: '저장됨',
  SAVE_FAILED: '저장 실패',
  // Phase 1: React Flow 노드 기본값
  FLOW_NODE_DEFAULT_LABEL: '새 실행 단계',
  FLOW_DETAIL_NODE_DEFAULT_LABEL: '새 세부 단계',
  FLOW_SECTION_DEFAULT_TITLE: '빈 섹션',
  FLOW_TEXT_DEFAULT_CONTENT: '텍스트',
  // Phase 2: Sidebar 라벨
  SIDEBAR_EMPTY_STATE: '실행 단계를 선택하세요',
  SIDEBAR_NODE_NAME_LABEL: '단계 이름',
  SIDEBAR_NODE_DESC_LABEL: '완료 조건',
  ...
  // AI 기능
  AI_GENERATE_ROADMAP: '실행 과제 생성',
  AI_MODIFY_ROADMAP: '실행 과제 수정',
  AI_MENU_LABEL: 'AI 메뉴',
  RESOURCE_DELETE_CONFIRM: '자료를 삭제하시겠습니까?',
  // Phase 4: AI Modal
  AI_MODAL_GENERATE_TITLE: 'AI 실행 과제 생성',
  AI_MODAL_MODIFY_TITLE: 'AI 실행 과제 수정',
  AI_MODAL_GENERATE_PLACEHOLDER:
    '어떤 결과물을 만들고 싶으신가요? (예: 로그인 E2E 테스트가 포함된 PR)',
  AI_MODAL_MODIFY_PLACEHOLDER:
    '실행 과제를 어떻게 수정하고 싶으신가요? (예: 완료 조건을 더 구체화해주세요)',
  AI_MODAL_CANCEL: '취소',
  AI_MODAL_GENERATE_BUTTON: '생성',
  AI_MODAL_MODIFY_BUTTON: '수정',
  AI_MODAL_LOADING: 'AI가 작업 중입니다...',
  AI_RESOURCE_MODAL_TITLE: 'AI 자료 추천',
  AI_RESOURCE_MODAL_SUBTITLE: '선택한 실행 단계에 적합한 참고 자료를 추천합니다',
  ...
  AI_GENERATE_ERROR: 'AI 실행 과제 생성에 실패했습니다',
  AI_MODIFY_ERROR: 'AI 실행 과제 수정에 실패했습니다',
