...
class EnvSettings(BaseSettings):
    ...
    AI_AUTH_JWT_ISSUER: str = "jagalchi-api"
    AI_AUTH_JWT_AUDIENCE: str = "jagalchi-ai"
...
AI_AUTH_JWT_ISSUER = env.AI_AUTH_JWT_ISSUER
AI_AUTH_JWT_AUDIENCE = env.AI_AUTH_JWT_AUDIENCE
